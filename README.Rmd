...
The [SOmap package](https://github.com/AustralianAntarcticDivision/) is part of a larger suite of packages to support science in the Southern Ocean and Antarctica. See the [SCAR/rOpenSci initiative](https://ropensci.org/blog/2018/11/13/antarctic/) for more information.
